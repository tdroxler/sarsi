{-# OPTIONS_GHC -Wall #-}
-- Taken From `elm-compiler` at `src/Reporting/Render/Code.hs
module Codec.ELM.Code
--    ( render
--    )
    where
--
...
--
--import qualified Codec.ELM.Log as R
--
--renderMessage :: Log.Message -> IO Doc
--renderMessage (Log.Message _ _ _ region subRegion file _) = do
--  source <- readFile file
--  return $ render subRegion region source
--
--
--(|>) :: a -> (a -> b) -> b
--(|>) a f =
